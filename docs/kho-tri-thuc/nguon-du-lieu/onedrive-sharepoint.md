...
1. Nhấn vào ảnh đại diện ở góc trên bên phải, chọn **Nguồn dữ liệu**. Trang này liệt kê các nguồn bạn đã tạo ở trên, và **Các nguồn khả dụng** ở dưới.
    ...
    ![Trang Nguồn dữ liệu](../../img/nguon-du-lieu/onedrive-sharepoint/01-nguon-du-lieu.jpg)

2. Cuộn xuống **Các nguồn khả dụng** và nhấn thẻ **OneDrive**.

    ![Chọn nguồn OneDrive](../../img/nguon-du-lieu/onedrive-sharepoint/02-chon-nguon.jpg)
...
3. Trong hộp thoại **Tạo trình kết nối OneDrive của bạn**, điền:
    ...
    ![Hộp thoại tạo kết nối OneDrive](../../img/nguon-du-lieu/onedrive-sharepoint/03-onedrive-thong-tin.jpg)
...
4. Cuộn xuống để xem các tùy chọn còn lại. Có thể để nguyên tất cả:
    ...
    ![Tùy chọn của kết nối OneDrive](../../img/nguon-du-lieu/onedrive-sharepoint/04-onedrive-tuy-chon.jpg)
...
2. Điền **Name**, **Site URL**, rồi **Tenant ID**, **Client ID**, **Client Secret**. Nhấn **Xác nhận**.
    ...
    ![Hộp thoại tạo kết nối SharePoint](../../img/nguon-du-lieu/onedrive-sharepoint/05-sharepoint-thong-tin.jpg)
...
3. Rê chuột vào dòng nguồn dữ liệu để hiện các nút thao tác:
    ...
    ![Mục Nguồn dữ liệu trong Cấu hình kho tri thức](../../img/nguon-du-lieu/onedrive-sharepoint/06-lien-ket-kho-tri-thuc.jpg)
...
![Danh sách tệp sau khi đồng bộ](../../img/nguon-du-lieu/onedrive-sharepoint/07-tep-da-dong-bo.jpg)
...
![Cài đặt tần suất đồng bộ](../../img/nguon-du-lieu/onedrive-sharepoint/08-tan-suat-dong-bo.jpg)
